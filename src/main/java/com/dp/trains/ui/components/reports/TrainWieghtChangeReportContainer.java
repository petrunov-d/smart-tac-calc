...
@Slf4j
public class TrainWieghtChangeReportContainer extends BaseSmartTacCalcView {
    ...
    public TrainWieghtChangeReportContainer(ReportService reportService) {
        ...
        H4 title = new H4(getTranslation(REPORTS_BUTTON_LABEL_TRAIN_WEIGHT_CHANGE_REPORT));
        ...
        downloadAsExcelFileButton.addClickListener(buttonClickEvent -> {
            ...
            try {
                ...
                reportService.getTrainWeightChangeReport(trainNumber.getValue(), fromDatePicker.getValue(), toDatePicker.getValue());
