...
public class AddMarkupCoefficientDialog extends SmartTACCalcDialogBase {

    public AddMarkupCoefficientDialog(Grid currentlyActiveGrid, MarkupCoefficientService markupCoefficientService) {
        ...
        save.addClickListener(event -> {
            ...
            if (binder.writeBeanIfValid(markupCoefficientDto)) {
                ...
                ListDataProvider<MarkupCoefficientEntity> dataProvider =
                        (ListDataProvider<MarkupCoefficientEntity>) currentlyActiveGrid.getDataProvider();

                MarkupCoefficientEntity markupCoefficientEntity = markupCoefficientService.add(markupCoefficientDto);
                dataProvider.getItems().add(markupCoefficientEntity);
